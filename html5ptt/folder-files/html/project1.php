		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project11.php">&#8592; Previous project</a>
					<a class="next-project" href="project2.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
					...
					<div class="info">
	        			...
	        			<p><strong>Sourse </strong>PTT HardwareSale</p>
	        		...
	        		<div class="entry-content">
	        			...
	        			<h2 class="heading">HardwareSale</h2>
					...
					<?php 
						...
						//$fp = fopen('ptt.txt', 'w');
						$html = file_get_html('https://www.ptt.cc/bbs/HardwareSale/index.html');
