		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project6.php">&#8592; Previous project</a>
					<a class="next-project" href="project8.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
					...
					<div class="info">
	        			...
	        			<p><strong>Sourse </strong>PTT Storage_Zone</p>
	        		...
	        		<div class="entry-content">
	        			...
	        			<h2 class="heading">Storage_Zone</h2>
	        			
	        			<div class="multicolumn">
	        			
						<?php 
						require_once('simple_html_dom.php');
						$html = file_get_html('https://www.ptt.cc/bbs/Storage_Zone/index.html');
