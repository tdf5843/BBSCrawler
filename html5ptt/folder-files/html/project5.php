		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project4.php">&#8592; Previous project</a>
					<a class="next-project" href="project6.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
	        		...
	        		<div class="entry-content">
	        			...
	        			<h2 class="heading">POWER SUPPLY</h2>
						...
						//echo $match1;
						//echo $match2;
						$html1 = file_get_html('https://www.ptt.cc/bbs/HardwareSale/index'.$match2.'.html');
						...
						foreach($re as $a)
						{
							...
							foreach($str as $b)
							{
								...
								foreach($str1 as $c)
								{
									...
									if(preg_match('/psu/', $c , $tsmc))
									{
										echo $c."</br></br>";
									}
									else if(preg_match('/0W/', $c , $tsmc))
									{
										echo $c."</br></br>";
									}
						...
						$html2 = file_get_html('https://www.ptt.cc/bbs/HardwareSale/index'.$match1.'.html');
						...
						$html3 = file_get_html('https://www.ptt.cc/bbs/HardwareSale/index'.$match0.'.html');
