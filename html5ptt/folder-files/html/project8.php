		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project7.php">&#8592; Previous project</a>
					<a class="next-project" href="project9.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
	        		...
	        		<div class="entry-content">
	        			...
	        			<h2 class="heading">Alternative civilian service</h2>
				...
				<div class="related-projects">
					...
					<div class="related-list cf">
						...
						<figure>
							<a href="project6.php" class="thumb"><img src="img/dummies/featured/06.jpg" alt="Alt text" /></a>
							<a href="project6.php" class="heading">TSMC</a>
						</figure>
					</div>
				</div>
				<!-- ENDS related -->
