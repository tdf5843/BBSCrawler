			...
			function showHint() {
			  var xmlhttp=new XMLHttpRequest();
			   xmlhttp.onreadystatechange=function() {
				  ...
				  xmlhttp.open("GET","ajax10.php",true);
				  xmlhttp.send();
			}
			showHint();
			</script>
		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project9.php">&#8592; Previous project</a>
					<a class="next-project" href="project11.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
					...
					<div class="info">
	        			...
	        			<p><strong>Sourse </strong>PTT Beauty</p>
	        		...
	        		<div class="entry-content">
	        			...
	        			<div id="txtHint" class="multicolumn">
						
					<?php 
					/*
						require_once('simple_html_dom.php');
						$arr = array('a href="' => 'a href="https://www.ptt.cc');
						$arr1 = array('<i' => '<img width="80px" height="75px"');
						//$fp = fopen('ptt.txt', 'w');
						...
						while($aw<$arraycou && $aw1<6)
						{
							...
							if($beautyr)
							{
								...
								if($bu)
								{
									...
									if($bu1)
									{	
										echo strtr($v,$arr),strtr($bu1,$arr1),"<br><br>";
										$aw1 += 1;
									}
								}
							}
				...
				<div class="related-projects">
					...
					<!--
						...
						<figure>
							<a href="#" class="thumb"><img src="img/dummies/featured/04.jpg" alt="Alt text" /></a>
							<a href="single.php" class="heading">PC_Shopping</a>
						</figure>
						
						
						<figure>
							<a href="project5.php" class="thumb"><img src="img/dummies/featured/05.jpg" alt="Alt text" /></a>
							<a href="project5.php" class="heading">POWER SUPPLY</a>
						</figure>
						
						<figure> 
							<a href="project7.php" class="thumb"><img src="img/dummies/featured/08.jpg" alt="Alt text" /></a>
							<a href="project7.php" class="heading">Storage_Zone</a>
						</figure>
						
						<figure>
							<a href="project9.php" class="thumb"><img src="img/dummies/featured/07.jpg" alt="Alt text" /></a>
							<a href="project9.php" class="heading">VideoCard</a>
						</figure>
						-->
					</div>
				</div>
