		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project10.php">&#8592; Previous project</a>
					<a class="next-project" href="project1.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
					...
					<div class="info">
	        			...
	        			<p><strong>Sourse </strong>PTT BuyTogether</p>
	        		...
	        		<div class="entry-content">
	        			...
	        			<h2 class="heading">BuyTogether</h2>
	        			
	        			<div class="multicolumn">
					
					<?php 
						require_once('simple_html_dom.php');
						$html = file_get_html('https://www.ptt.cc/bbs/BuyTogether/index.html');
						...
						//echo $match1;
						//echo $match2;
						$html1 = file_get_html('https://www.ptt.cc/bbs/BuyTogether/index'.$match2.'.html');
						...
						$html2 = file_get_html('https://www.ptt.cc/bbs/BuyTogether/index'.$match1.'.html');
						...
						$html3 = file_get_html('https://www.ptt.cc/bbs/BuyTogether/index'.$match0.'.html');
