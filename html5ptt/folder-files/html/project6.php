		...
		<div id="main">
        	...
        	<div id="portfolio-content" class="cf">        	
				...
				<div class="project-pager cf">
					<a class="previous-project" href="project5.php">&#8592; Previous project</a>
					<a class="next-project" href="project7.php">Next project &#8594;</a>
				</div>
				<!-- ENDS project pager -->
				...
				<div id="project-box" class="cf">
					...
					<div class="info">
	        			...
	        			<p><strong>Sourse </strong>PTT Tech_Job</p>
	        		...
	        		<div class="entry-content">
	        			...
	        			<h2 class="heading">TSMC</h2>
	        			
	        			<div class="multicolumn">
	        			<?php 
						require_once('simple_html_dom.php');
						$html = file_get_html('https://www.ptt.cc/bbs/Tech_Job/index.html');
						$result = $html->find('div.title');
						$result2 = $html->find('a.btn');
						$new = $result2[3];
						//echo $new;
						preg_match('/\d+/', $new , $match);
						$match0 = $match[0]-0;
						$match1 = $match[0]-1;
						$match2 = $match[0]-2;
						//echo $match0;
						//echo $match1;
						//echo $match2;
						$html1 = file_get_html('https://www.ptt.cc/bbs/Tech_Job/index'.$match2.'.html');
						$re = $html1->find('div.title');
						foreach($re as $a)
						{
							...
							foreach($str as $b)
							{
								...
								{
									//fwrite($fp, $j."\r\n");
									$c = preg_replace('/a href="/','a href="https://www.ptt.cc',$c);
									if(preg_match('/台積/', $c , $tsmc))
									{
										echo $c."</br></br>";
									}
						...
						$html2 = file_get_html('https://www.ptt.cc/bbs/Tech_Job/index'.$match1.'.html');
						$re = $html2->find('div.title');
						foreach($re as $a)
						{
						...
						$html3 = file_get_html('https://www.ptt.cc/bbs/Tech_Job/index'.$match0.'.html');
						$re = $html3->find('div.title');
						foreach($re as $a)
						{
				...
				<div class="related-projects">
					...
					<div class="related-list cf">
						...
						<figure>
							<a href="project8.php" class="thumb"><img src="img/dummies/featured/09.jpg" alt="Alt text" /></a>
							<a href="project8.php" class="heading">Alternative civilian service</a>
						</figure>
					</div>
				</div>
				<!-- ENDS related -->
